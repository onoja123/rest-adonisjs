            ...
            <div className={css.leftSide}>
                {
                    projectExperience.map((exp, i)=> {
                        return <motion.div variants = {fadeIn("right", "tween", (i+1)*0.2, 1)} className={css.exp} key={i}>
                            ...
                            <div>
                                <span>{exp.name}</span>
                                <span className='secondaryText'>{exp.projects} Colabration</span>
                            </div>
                        </motion.div>
                    })
                }
            ...
            className={css.rightSide}>
                ...
                <div className={`flexCenter ${css.stats}`}>
                    <div className={`flexCenter ${css.stat}`}>
                        ...
                        <span className='secondaryText'>Number of artists</span>
                    </div>
                    <div className={`flexCenter ${css.stat}`}>
                        <span className='primaryText'>190+</span>
                        <span className='secondaryText'>Released Jams</span>
                    </div>
                </div>
            </motion.div>
        </motion.div>
